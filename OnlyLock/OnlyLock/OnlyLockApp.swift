...
private enum AppLanguageEnglishOverrides {
    static let translations: [String: String] = [
        ...
        "你喜欢目前的进展方式吗？": "Do you like the progress so far?",
        "是": "Yes",
        "否": "No",
...
private enum AppLanguageEnglishMap {
    static let translations: [String: String] = [
        ...
        "OnlyLock会员": "OnlyLock membership",
        ...
        "你喜欢目前的进展方式吗？": "Do you like the way things are going?",
        ...
        "你还没有锁定任务": "You haven't locked the task yet",
        "使用条款": "terms of use",
        "保持专注": "stay focused",
        ...
        "开启权限后可查看屏幕时间分析": "After turning on permission, you can view screen time analysis",
        ...
        "续费后继续创建锁定任务并管理应用与网站。": "After renewal, continue to create locked tasks and manage apps and websites.",
        ...
        "解锁所有会员功能": "Unlock all membership features",
